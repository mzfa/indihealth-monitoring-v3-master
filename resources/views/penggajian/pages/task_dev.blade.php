...
@section('title','Lihat detail progress projek ')
@section('subtitle',$linked->project->name)
@section('content')
<style type="text/css">
...
<script type="text/javascript">
    ...
    "processing": "<i class='fas fa-spinner fa-spin fa-1x'></i> Sedang mengambil data..."
                    ...
                    ajax: "{{ route('guest.taskdev.datatables',['id' => $id])}}",
                    columns: [{
                            data: 'task_name',
                            name: 'task_name'
                        },
    ...
    $('#form-filter').submit(function(e){
        ...
        $('#task-table').DataTable({
                    ...
                    "language": {
                         ...
                         ajax: {
                          "url": "{{ route('guest.taskdev.datatables',['id' => $id])}}?start_date="+$("#start_date-filter").val()+"&end_date="+$("#end_date-filter").val()+"&progress="+$("#progress-filter").val(),
                          "type": "GET",
                        },
                          columns: [{
                                  data: 'task_name',
     ...
     function findDate(date)
      {
        ...
        $('#task-table').DataTable({
                    ...
                    "language": {
                         ...
                         ajax: {
                          "url": "{{ route('guest.taskdev.datatables',['id' => $id])}}?start_date="+date+"&end_date="+date,
                          "type": "GET",
                        },
                          columns: [{
                                  data: 'task_name',
    ...
    $('#form-task-select-tanggal').submit(function(e){
        ...
        $('#task-table').DataTable({
                    ...
                    "language": {
                         ...
                         ajax: {
                          "url": "{{ route('guest.taskdev.datatables',['id' => $id])}}?start_date="+$("#tanggal_select").val()+"&end_date="+$("#tanggal_select").val(),
                          "type": "GET",
                        },
                          columns: [{
                                  data: 'task_name',
