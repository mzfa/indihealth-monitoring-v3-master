...
@endif
@if($data->status == null)
  <a title="Setujui" href="{{route('izin.approve',['id' => $data->id])}}" onclick="return confirm('Anda akan membatalkan ini?');" class="btn btn-success"><i id="icon-req-{{$data->id}}" class="fas fa-check"></i></a> 
