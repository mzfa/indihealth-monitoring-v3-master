...
<head>
  ...
  <title>System log viewer  | {{config('app.app_name')}}</title>
...
<body>
<div class="@if(Agent::isMobile()) @else container-fluid @endif">
  <div class="row">
    <div class="col-3 sidebar mb-3">
      {{auth()->user()->name}}, <a
                            href="{{ route('logout') }}"
      ...
      <a href="{{route('home')}}" class="btn btn-outline-primary btn-block mt-2">Dashboard</a>
    </div>
  </div>
  <hr>
  <div class="row">
    <div class="col sidebar mb-3">
      <h1><i class="fa fa-calendar" aria-hidden="true"></i> System Log Viewer<br><small>{{date('Y-m-d')}}</small></h1>
